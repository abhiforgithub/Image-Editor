...
import com.example.imageeditorapp.CropImageOptions.Companion.DEGREES_360
import com.example.imageeditorapp.CropImageView.CropResult
import com.example.imageeditorapp.CropImageView.CropShape
import com.example.imageeditorapp.CropImageView.RequestSizeOptions
 ...
 * question](http://stackoverflow.com/questions/32789027/android-m-camera-intent-permission-bug).
    ...
    class ActivityBuilder(private val mSource: Uri?) {
         ...
         * *Default: JPEG*
         */
        fun setOutputCompressFormat(outputCompressFormat: Bitmap.CompressFormat?): ActivityBuilder {
